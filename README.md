...
> 当前版本：`v0.1.0-beta.1`。这是独立社区项目，与 OpenAI 没有隶属关系，也不代表 OpenAI 官方背书。
...
1. 从 [Releases](https://github.com/XuYing1128/XiaoLi/releases) 下载 `XiaoLi-v0.1.0-beta.1-Windows-x64-portable.zip`。
...
1. 下载并解压 `XiaoLi-v0.1.0-beta.1-macOS-universal.app.zip`。
